...
const PlayPause:React.FC<Props> = (props) => (
    <button onClick={props.togglePlayPause} type="button" className='bg-primarygreen flex justify-center to-transparent w-12 h-12 mr-1 rounded-full items-center'>
        {props.isPlaying ?
        (
