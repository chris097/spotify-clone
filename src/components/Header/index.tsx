...
const Header = () => {
  return (
    <div className='bg-lightgray w-full pl-64 h-20 flex justify-between items-center font-sourcesan pr-8'>
      ...
      <div className='flex space-x-10'>
        <button className='border border-basegray w-24 text-white hover:bg-black hover:border-white rounded-full'>Upgrade</button>
        <button className='flex items-center bg-black w-[180px] justify-center space-x-2 rounded-full pr-2 py-1 hover:bg-basegray'>
          ...
          <span className='whitespace-nowrap truncate text-white'>Christian Chiemela</span>
